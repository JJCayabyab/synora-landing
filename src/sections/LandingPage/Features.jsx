        ...
        {FeaturesData.map((feature, index) => (
          ...
          >
            <div className="h-full inset-shadow-xs  dark:bg-[#1e293b] p-6 rounded-2xl shadow-md flex flex-col items-center text-center">
              ...
              />
              <h3
                className="font-semibold text-lg mb-2 text-gradient 
                           md:text-2xl"
              >
                {feature.title}
              </h3>
    ...
    <Container className="">
      <motion.h1
        ...
        className="font-heading text-heading-1 font-bold text-2xl mb-5 text-center
                   ...
                   lg:text-4xl"
      >
        <span className="text-gradient">Smarter</span> Tools. <br />
        <span className="text-gradient">Human-Centered</span> AI.
      </motion.h1>
